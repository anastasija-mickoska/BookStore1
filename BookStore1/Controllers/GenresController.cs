...
namespace BookStore1.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(BookStore1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var genre= await _context.Genre.FirstOrDefaultAsync();
            var book = await _context.Book
            .Include(b => b.Genres) // Include the collection navigation property for genres
            ...
            if (genre != null)
            {
                var booksToAdd = new List<BookGenre>();
                _context.BookGenre
                .Where(bg => bg.GenreId == id)
                .Select(bg => bg.Book)
                .ToList();
                foreach (var book1 in booksToAdd)
                {
